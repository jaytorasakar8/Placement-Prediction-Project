...
<!-- My imported libraries -->
        ...
        <link href="pages/admin/css/search1.css" rel="stylesheet" type="text/css">
   ...
   response.setHeader("Location","?task=login"); 
    ...
    <span class="dropbtn" style="color: Blue; margin-left:40%; font-size: x-large; " >Welcome ! <c:out value="${name }" /></span>
      <span style="margin-left:20%;" class="btn btn-primary">
          <a style="color: #8cff1a; text-decoration:none; font-size: x-large;" href="<%=request.getContextPath() %>/Admin?task=logout">LOGOUT</a></span>
...
<c:forEach var="row00" items="${row001.rows}">
        ...
        <article class="search-result row">
            <div class="col-xs-12 col-sm-12 col-md-3">
                <a href="#"  class="thumbnail"><img src="pages/admin/images/user1.jpg" /></a>
            </div>

            <div class="col-xs-12 col-sm-12 col-md-2">
                <ul class="meta-search">
                    <li><i class="glyphicon glyphicon-education"></i><span><font size="4">Bachelor of Engineering</font></span></li>
                    <li><i class="glyphicon glyphicon-user"></i> <span><font size="4">ID: <c:out value="${row00.id }" /></font></span></li>
            ...
            <div class="col-xs-12 col-sm-12 col-md-7 excerpet">
                ...
                <center><a href="<%=request.getContextPath() %>/Admin?task=viewStudentProfile&StudentID=<c:out value="${row00.id }" />" class="btn btn-md btn-success">View Profile</a>
           		<a href="<%=request.getContextPath() %>/Admin?task=updateStudentProfile&StudentID=<c:out value="${row00.id }" />" class="btn btn-md btn-info">Update Profile</a></center>
            </div>
