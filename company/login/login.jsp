...
<html >
  <head>
    ...
    <title>Placement Portal | Company Login</title>
    	<link rel="stylesheet" href="pages/company/login/css/style.css">
  </head>
...
<img src="pages/company/images/aceLogo.jpg" style="height: 80px; width: 70px;"> <br>
...
<br>Company Login
    ...
    <script src='http://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script>
        ...
        <script src="pages/company/login/js/index.js"></script>
