...
<head>
  ...
  <script type="text/javascript" src="pages/company/js/jquery.backstretch.min.js"></script>
  <script type="text/javascript" src="pages/company/js/result.js"></script>
  <link rel="stylesheet" type="text/css" href="pages/company/css/result.css">
  <link rel="stylesheet" href="pages/company/fontawesome/css/font-awesome.min.css">
  <script src="pages/company/js/canvasjs.min.js"></script>

<!-- for charts-->
  <script type="text/javascript" src="pages/company/js/chart1.js"></script>
  <style>
	   .img-circle {
    border-radius: 50%;}	
    </style>
    ...
    <div class="well well-lg" >
		<div class="row">
			<div class="col-md-3">
            	...
            	<img class="img-circle" style="width: 210px;height:150px;" alt="<c:out value="${row00.name }" />" src="pages/company/images/user1.jpg">
			...
			<div class="col-md-3 col-md-offset-1">
				...
				<a class="btn btn-success btn-md" href="<%=request.getContextPath() %>/Company">Search Another Student</a>
			</div>
	...
	<div class="panel-group">
	    <div class="panel panel-primary">
			...
			<div class="panel-body">
      		 	...
      		 	<div class="progress">
    				<div class="progress-bar progress-bar-default progress-bar-striped active" role="progressbar" aria-valuenow="40"
    				 aria-valuemin="0" aria-valuemax="100" style="width:<c:out value="${(((row00.c)+(row00.cpp)+(row00.java))*100)/60 }" />%">
    				     <c:out value="${(((row00.c)+(row00.cpp)+(row00.java))*100)/60 }" /> %</div>
  				</div>
			</div>
    	</div>
    </div>
     	  ...
     	  <div class="panel-heading"><b>Result and Analysis</b></div>
      	  <div class="panel-body">
      		<ul class="nav nav-tabs nav-justified">
    			...
    			<li><a data-toggle="tab" href="#menu3">Personality</a></li>
...
<!--end of menu 2></!-->
   ...
   <div id="menu3" class="tab-pane fade">
       ...
       <h3>Personality Scores Scores</h3>
    	<div class="row">
    	<div class="col-md-12">
    		<table class="table table-hover table-striped table-bordered">
   		 <thead>
        ...
        <td><center>Personality Test</td>
        <td><center>  <c:out value="${row00.personality }" /> </center></td>
        <td><center>20</center></td>
        <td><center><c:out value="${((row00.personality)*100)/20 }" /> %</center></td>
    	</tr>
...
function a6() {
	var chart = new CanvasJS.Chart("chartContainer6", {
		title: {
			text: "Personality Test Analysis"
		},
		animationEnabled: true,
		theme: "theme2",
		data: [
		{
			...
			dataPoints: [
			{ y: <c:out value="${((row00.personality)*100)/20 }" /> , indexLabel: "Questions Correct {y}%" },
			{ y: <c:out value="${(100-((row00.personality)*100)/20) }" />, indexLabel: "Questions Incorrect {y}%" },
