...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Company Search Engine</title>
...
<!-- My imported libraries -->
        ...
        <link href="pages/company/css/index.css" rel="stylesheet" type="text/css">
   ...
   response.setHeader("Location","?task=login"); 
    ...
    <span class="dropbtn" style="color: yellow; margin-left:40%; font-size: x-large; " >Welcome ! <c:out value="${name }" /></span>
      <span class="btn btn-primary">
         <a style="color: orange;  margin-left:20%; font-size: x-large;" href="<%=request.getContextPath() %>/Company?task=logout">LOGOUT</a>
       </span>
